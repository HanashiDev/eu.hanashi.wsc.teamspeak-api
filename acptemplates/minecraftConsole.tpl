...
<header class="contentHeader">
    <div class="contentHeaderTitle">
        <h1 class="contentTitle">{lang}wcf.acp.menu.link.configuration.minecraft.minecraftConsole{/lang}
            {$connectionName}<h1>
    </div>
...
{if $response|isset}
    <div class="section">
        ...
        <dd>
            <textarea type="text" id="response" name="response"
                style="resize: vertical; max-height: 20rem; min-height: 5rem" readonly>{$response}</textarea>
        </dd>
    </div>
{/if}
...
<div class="section tabularBox">
    <a href="https://minecraft.fandom.com/wiki/Commands"
        target="_blank">{lang}wcf.page.minecraftConsole.commandListDefault{/lang}</a><br />
    <a href="https://bukkit.fandom.com/wiki/CraftBukkit_Commands"
        target="_blank">{lang}wcf.page.minecraftConsole.commandListBukkit{/lang}</a><br />
    <a href="https://www.spigotmc.org/wiki/spigot-commands/"
        target="_blank">{lang}wcf.page.minecraftConsole.commandListSpigot{/lang}</a><br />
    <a href="https://www.spigotmc.org/wiki/bungeecord-commands/"
        target="_blank">{lang}wcf.page.minecraftConsole.commandListBungeeCord{/lang}</a>
</div>
